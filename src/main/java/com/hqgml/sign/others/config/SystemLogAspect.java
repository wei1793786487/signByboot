...
import com.hqgml.sign.others.utlis.ThreadPoolUtil;
...
public class SystemLogAspect {
     ...
     * Controller层切点,注解方式
     */
    @Pointcut("@annotation(com.hqgml.sign.others.annotation.ControllerLog)")
     ...
     * Service层切点,注解方式
     */
    @Pointcut("@annotation(com.hqgml.sign.others.annotation.ServiceLog)")
